...
import { Branch } from "../AdminPage/Models/Branch.js";
...
let branch = await Branch.getBranch(branchid)
...
function cell(index) {
    ...
    if(finaltable[index].Faculty.Id != Number(sessionStorage.getItem("id")))
        return `Free Slot`
